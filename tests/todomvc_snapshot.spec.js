...
test.describe('TodoMVC', function () {
  ...
  test('Loads the app', async function ({ page }) {
    ...
    await percySnapshot(page, 'Loads the app', { browsers: ['Chrome'] });
  });
  ...
  test('Accepts a new todo', async function ({ page }) {
    ...
    await percySnapshot(page, 'Snapshot with new todo', { browsers: ['Chrome'] });
  });
  ...
  test('Lets you check off a todo', async function ({ page }) {
    ...
    await percySnapshot(page, 'Checked off todo', { browsers: ['Chrome'] });
  });
});
